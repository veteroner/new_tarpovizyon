...
const sections: ModuleSection[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { title: 'Çapraz İstihbarat', subtitle: 'Korelasyon analizi', icon: BarChart3, path: '/tarpovizyon/turkey/cross-intelligence', iconColor: 'text-purple-400', bgColor: 'bg-purple-500/10' },
    ],
  },
  {
