...
export async function fetchRows(endpoint: string, params: Record<string, string> = {}): Promise<Row[]> {
  ...
  /* Elle sürümleme kaldırıldı — Worker artık önbellek anahtarına tablonun
     damgasını koyuyor ve istemci TTL'i 60 sn. Bkz. services/d1.ts başındaki
     açıklama ve workers/tarpovizyon-api/src/damga.js. */
