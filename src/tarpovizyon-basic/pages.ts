      ...
      },
      {
        ...
        config: {
          ...
          tiles: [
            ...
            { field: 'ayran_ton', label: 'Ayran Üretimi', unit: 'Ton' },
      ...
      },
      {
        ...
        config: {
          ...
          tiles: [
            ...
            { field: 'karlilik', label: 'Karlılık' },
            { field: 'sut_yemi_19hp', label: 'Süt Yemi (%19 HP)', unit: 'TL/Kg' },
            { field: 'misir_silaji', label: 'Mısır Silajı', unit: 'TL/Kg' },
            { field: 'yonca', label: 'Yonca (Kuru Ot)', unit: 'TL/Kg' },
            { field: 'saman', label: 'Saman', unit: 'TL/Kg' },
          ],
        },
      },
    ],
      ...
      },
      {
        ...
        config: {
          ...
          tiles: [
            { field: 'dana_karkas_maliyet_tl_kg', label: 'Dana Karkas Maliyeti', unit: 'TL/Kg' },
            { field: 'dana_karkas_fiyati_tl_kg', label: 'Dana Karkas Fiyatı', unit: 'TL/Kg' },
            { field: 'dana_karkas_fiyat_maliyet_farki_tl_kg', label: 'Dana Fiyat-Maliyet Farkı', unit: 'TL/Kg' },
            { field: 'besi_yemi_fiyati_tl_kg', label: 'Besi Yemi Fiyatı', unit: 'TL/Kg' },
            { field: 'besilik_dana_fiyati_tl_kg', label: 'Besilik Dana Fiyatı', unit: 'TL/Kg' },
            { field: 'kuzu_karkas_fiyati_tl_kg', label: 'Kuzu Karkas Fiyatı', unit: 'TL/Kg' },
            { field: 'karkas_paritesi', label: 'Karkas Paritesi' },
            { field: 'karlilik', label: 'Karlılık' },
          ],
      ...
      },
      {
        ...
        config: {
          ...
          series: [
            ...
            { key: 'dana_karkas_fiyati_tl_kg', label: 'Fiyat (TL/Kg)', type: 'bar' },
            { key: 'dana_karkas_fiyat_maliyet_farki_tl_kg', label: 'Fiyat-Maliyet Farkı (TL/Kg)', type: 'line', axis: 'right' },
          ],
        },
      },
      {
