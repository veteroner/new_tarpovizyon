...
// İçecek Bitkileri ürün kodları - FAO
const PRODUCTS = [
  { id: '656', nameTR: 'Kahve' },
  { id: '667', nameTR: 'Kakao' },
  { id: '674', nameTR: 'Çay' },
  { id: '677', nameTR: 'Mate' },
  { id: '689', nameTR: 'Şerbetçi Otu' },
]

const COLORS = ['#6F4E37', '#D2691E', '#228B22', '#8B4513', '#DAA520']
...
export default function BeverageCropPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-800 to-green-800 rounded-xl shadow-lg p-6 text-white">
        <h1 className="text-3xl font-bold mb-2">☕ İçecek Bitkileri Üretimi</h1>
        <p className="opacity-90">FAO verileriyle dünya içecek bitkileri üretim istatistikleri (Ton)</p>
      </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={productionData} layout="vertical">
                  ...
                  <Bar dataKey="production" fill="#6F4E37" name="Üretim" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <AreaChart data={trendData}>
                  ...
                  <Tooltip formatter={(value: number) => formatTon(value)} />
                  <Area type="monotone" dataKey="production" stroke="#6F4E37" fill="#D2B48C" name="Üretim" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">
                ☕ İçecek Bitkileri Karşılaştırması ({selectedYear})
              </h3>
              <ResponsiveContainer width="100%" height={350}>
