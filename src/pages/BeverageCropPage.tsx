...
const COLORS = ['#6F4E37', '#8B4513', '#A0522D', '#CD853F', '#D2691E', '#DEB887', '#F5DEB3', '#D2B48C', '#BC8F8F', '#F4A460'];

// FAO ürün kodları ile içecek bitkileri
const BEVERAGE_PRODUCTS = [
  { id: '656', name: 'Coffee, green', nameTR: 'Kahve' },
  { id: '661', name: 'Tea leaves', nameTR: 'Çay' },
  { id: '667', name: 'Cocoa beans', nameTR: 'Kakao' },
  { id: '671', name: 'Mate leaves', nameTR: 'Mate' },
];
...
export default function BeverageCropPage() {
  const [selectedProducts, setSelectedProducts] = useState<string[]>(['656', '661', '667']);
    ...
    try {
      ...
      if (productRes.data) {
        const mapped = productRes.data.map((item, index: number) => {
          ...
          const product = BEVERAGE_PRODUCTS.find(p => p.id === urunKod);
          return {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Dünya içecek bitkileri üretim miktarları - FAO {selectedYear} (Ton)</p>
      </div>
      ...
      <div className="date-filter">
        <div className="filter-group">
          ...
          <ProductSelector
            ...
            placeholder="İçecek bitkisi seçin..."
          />
        </div>
        <div className="filter-group">
          <label className="filter-label">
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={countryData.slice(0, 10)}>
                  ...
                  <Legend />
                  <Bar yAxisId="left" dataKey="value" name="Üretim" fill="#6F4E37" radius={[4, 4, 0, 0]} />
                  <Line yAxisId="right" type="monotone" dataKey="share" name="Pay %" stroke="#8B4513" strokeWidth={2} dot={{ fill: '#8B4513' }} />
                </ComposedChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Üretim (M ton)" dataKey="value" stroke="#6F4E37" fill="#6F4E37" fillOpacity={0.5} />
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ScatterChart>
                  ...
                  <Scatter name="Ürünler" data={scatterData} fill="#6F4E37">
