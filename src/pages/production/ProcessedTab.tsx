    ...
    <div style={{ animation: 'slideInUp 0.4s ease-out' }}>
      ...
      {processedKPIs && (<>
        ...
        <div className="chart-grid" style={{ marginBottom: '24px' }}>
          <ChartCard title="Trend — Dünya vs Türkiye" action={<ChartInsightButton title="İşlenmiş Üretim Trendi — Dünya vs Türkiye" description="Yıllık dünya ve Türkiye işlenmiş ürün trendi" data={endeksle(processedTrends, ['world', 'turkey'])} context={{ ürün: processedProduct }} />}>
            <ResponsiveContainer width="100%" height={350}>
              <LineChart data={endeksle(processedTrends, ['world', 'turkey'])}>
