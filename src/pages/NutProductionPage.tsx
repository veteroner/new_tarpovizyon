...
// Kuruyemiş ürün kodları - FAO
const PRODUCTS = [
  { id: '220', nameTR: 'Fındık' },
  { id: '221', nameTR: 'Badem' },
  { id: '222', nameTR: 'Ceviz' },
  { id: '223', nameTR: 'Kestane' },
  { id: '224', nameTR: 'Fıstık' },
  { id: '225', nameTR: 'Kaju' },
  { id: '226', nameTR: 'Antep Fıstığı' },
  { id: '229', nameTR: 'Kuruyemiş (Diğer)' },
]

const COLORS = ['#8B4513', '#CD853F', '#DEB887', '#D2691E', '#A0522D', '#BC8F8F', '#F4A460', '#DAA520']
...
export default function NutProductionPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-700 to-yellow-800 rounded-xl shadow-lg p-6 text-white">
        <h1 className="text-3xl font-bold mb-2">🥜 Kuruyemiş Üretimi</h1>
        <p className="opacity-90">FAO verileriyle dünya kuruyemiş üretim istatistikleri (Ton)</p>
      </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={productionData} layout="vertical">
                  ...
                  <Bar dataKey="production" fill="#8B4513" name="Üretim" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <AreaChart data={trendData}>
                  ...
                  <Tooltip formatter={(value: number) => formatTon(value)} />
                  <Area type="monotone" dataKey="production" stroke="#8B4513" fill="#DEB887" name="Üretim" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">
                🥜 Kuruyemiş Türleri Karşılaştırması ({selectedYear})
              </h3>
              <ResponsiveContainer width="100%" height={350}>
