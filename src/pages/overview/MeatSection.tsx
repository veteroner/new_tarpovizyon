  ...
  return (
    <>
      <div className="section-header" style={{ marginTop: '3rem', marginBottom: '1rem', borderTop: '2px solid var(--border)', paddingTop: '2rem' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: '600', color: 'var(--text-primary)' }}>Et Üretimi</h2>
      </div>
      ...
      <div className="kpi-grid">
        <div className="kpi-card">
          <div className="kpi-header"><span className="kpi-title">TOPLAM ET</span><div className="kpi-icon"><Beef size={18} aria-hidden="true" /></div></div>
          <div className="kpi-value">{formatNumber(data.meatProduction.total)} ton</div>
