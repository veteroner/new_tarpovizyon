...
// Meyve ürün kodları - FAO
const PRODUCTS = [
  { id: '515', nameTR: 'Elma' },
  { id: '486', nameTR: 'Muz' },
  { id: '560', nameTR: 'Üzüm' },
  { id: '490', nameTR: 'Portakal' },
  { id: '497', nameTR: 'Limon' },
  { id: '534', nameTR: 'Şeftali' },
  { id: '526', nameTR: 'Kayısı' },
  { id: '544', nameTR: 'Kiraz' },
  { id: '554', nameTR: 'Erik' },
  { id: '572', nameTR: 'Kivi' },
  { id: '567', nameTR: 'Çilek' },
  { id: '495', nameTR: 'Greyfurt' },
  { id: '571', nameTR: 'Mango' },
  { id: '600', nameTR: 'Kavun' },
  { id: '567', nameTR: 'Karpuz' },
  { id: '531', nameTR: 'Armut' },
  { id: '512', nameTR: 'Ayva' },
  { id: '550', nameTR: 'Vişne' },
]

const COLORS = ['#FF6B6B', '#4ECDC4', '#45B7D1', '#96CEB4', '#FFEAA7', '#DDA0DD', '#98D8C8', '#F7DC6F', '#BB8FCE', '#85C1E9', '#F8B500', '#00CED1', '#FF69B4', '#32CD32', '#FFD700', '#9370DB', '#20B2AA', '#FF7F50']
...
export default function FruitProductionPage() {
  ...
  // Trend verilerini getir (dünya toplamı)
  useEffect(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
        <h1 className="text-3xl font-bold mb-2">🍎 Meyve Üretimi</h1>
        <p className="opacity-90">FAO verileriyle dünya meyve üretim istatistikleri (Ton)</p>
      </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={productionData} layout="vertical">
                  ...
                  <Bar dataKey="production" fill="#FF6B6B" name="Üretim" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <AreaChart data={trendData}>
                  ...
                  <Tooltip formatter={(value: number) => formatTon(value)} />
                  <Area type="monotone" dataKey="production" stroke="#FF6B6B" fill="#FFAAAA" name="Üretim" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">
                🍎 Meyve Türleri Karşılaştırması ({selectedYear})
              </h3>
              <ResponsiveContainer width="100%" height={350}>
                <BarChart data={comparisonData.slice(0, 10)}>
                  ...
                  <Bar dataKey="value" name="Üretim" radius={[4, 4, 0, 0]}>
                    {comparisonData.slice(0, 10).map((_, index) => (
                      <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                    ))}
                  </Bar>
                </BarChart>
