...
// FAO ürün kodları ile meyveler
const FRUIT_PRODUCTS = [
  { id: '515', name: 'Apples', nameTR: 'Elma' },
  { id: '486', name: 'Bananas', nameTR: 'Muz' },
  { id: '560', name: 'Grapes', nameTR: 'Üzüm' },
  { id: '490', name: 'Oranges', nameTR: 'Portakal' },
  { id: '497', name: 'Lemons', nameTR: 'Limon' },
  { id: '534', name: 'Peaches', nameTR: 'Şeftali' },
  { id: '526', name: 'Apricots', nameTR: 'Kayısı' },
  { id: '544', name: 'Cherries', nameTR: 'Kiraz' },
  { id: '554', name: 'Plums', nameTR: 'Erik' },
  { id: '572', name: 'Kiwi', nameTR: 'Kivi' },
];
...
export default function FruitProductionPage() {
  const [selectedProducts, setSelectedProducts] = useState<string[]>(['515', '486', '560']);
    ...
    try {
      ...
      if (productRes.data) {
        const mapped = productRes.data.map((item, index: number) => {
          ...
          const product = FRUIT_PRODUCTS.find(p => p.id === urunKod);
          return {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Dünya meyve üretim miktarları - FAO {selectedYear} (Ton)</p>
      </div>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={countryData.slice(0, 10)}>
                  ...
                  <Legend />
                  <Bar yAxisId="left" dataKey="value" name="Üretim" fill="#FF6B6B" radius={[4, 4, 0, 0]} />
                  <Line yAxisId="right" type="monotone" dataKey="share" name="Pay %" stroke="#4ECDC4" strokeWidth={2} dot={{ fill: '#4ECDC4' }} />
                </ComposedChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Üretim (M ton)" dataKey="value" stroke="#FF6B6B" fill="#FF6B6B" fillOpacity={0.5} />
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ScatterChart>
                  ...
                  <Scatter name="Ürünler" data={scatterData} fill="#FF6B6B">
