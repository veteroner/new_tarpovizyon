  ...
  return (
    <div className="space-y-6 pb-8 max-w-[1400px] mx-auto">
      ...
      {crossData.length > 4 && (() => {
        ...
        /*
         * Hücre yazısı zeminin AÇIKLIĞINDAN türetiliyor. Eskiden `|v| >= 0.4`
         * ise beyaz yazılıyordu; ama o aralığın zemini açık yeşil/kırmızı,
         * beyaz yazı orada 1.8:1 veriyordu. Ortak yardımcı: utils/contrast.
         */
        const cellFg = (v: number) => okunurMetin(cellBg(v));
        return (
          <div className="rounded-xl border p-5 shadow-sm" style={{ background: 'var(--bg-card)' }}>
            <h3 className="font-semibold mb-3 flex items-center gap-2" style={{ color: 'var(--text-primary)' }}>
