...
// Lif Bitkileri ürün kodları - FAO
const PRODUCTS = [
  { id: '328', nameTR: 'Pamuk' },
  { id: '773', nameTR: 'Jüt' },
  { id: '777', nameTR: 'Kenevir' },
  { id: '780', nameTR: 'Keten' },
  { id: '782', nameTR: 'Sisal' },
  { id: '789', nameTR: 'Hindistan Cevizi Lifi' },
]

const COLORS = ['#F5F5DC', '#D2B48C', '#8FBC8F', '#B0C4DE', '#DEB887', '#E6E6FA']
...
export default function FiberCropPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-gray-600 to-slate-700 rounded-xl shadow-lg p-6 text-white">
        <h1 className="text-3xl font-bold mb-2">🧵 Lif Bitkileri Üretimi</h1>
        <p className="opacity-90">FAO verileriyle dünya lif bitkileri üretim istatistikleri (Ton)</p>
      </div>
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={productionData} layout="vertical">
                  ...
                  <Bar dataKey="production" fill="#708090" name="Üretim" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={350}>
                <AreaChart data={trendData}>
                  ...
                  <Tooltip formatter={(value: number) => formatTon(value)} />
                  <Area type="monotone" dataKey="production" stroke="#708090" fill="#D3D3D3" name="Üretim" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800">
                🧵 Lif Bitkileri Karşılaştırması ({selectedYear})
              </h3>
              <ResponsiveContainer width="100%" height={350}>
