...
const COLORS = ['#2ECC71', '#27AE60', '#1ABC9C', '#16A085', '#3498DB', '#2980B9', '#9B59B6', '#8E44AD', '#E74C3C', '#C0392B'];

// FAO ürün kodları ile şekerli bitkiler
const SUGAR_PRODUCTS = [
  { id: '156', name: 'Sugar cane', nameTR: 'Şeker Kamışı' },
  { id: '157', name: 'Sugar beet', nameTR: 'Şeker Pancarı' },
  { id: '161', name: 'Sugar crops nes', nameTR: 'Diğer Şeker Bitkileri' },
];
...
export default function SugarCropProductionPage() {
  const [selectedProducts, setSelectedProducts] = useState<string[]>(['156', '157']);
    ...
    try {
      ...
      if (productRes.data) {
        const mapped = productRes.data.map((item, index: number) => {
          ...
          const product = SUGAR_PRODUCTS.find(p => p.id === urunKod);
          return {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Dünya şekerli bitki üretim miktarları - FAO {selectedYear} (Ton)</p>
      </div>
      ...
      <div className="date-filter">
        <div className="filter-group">
          ...
          <ProductSelector
            products={SUGAR_PRODUCTS}
            selectedProducts={selectedProducts}
            onSelectionChange={setSelectedProducts}
            placeholder="Şekerli bitki seçin..."
          />
        </div>
        <div className="filter-group">
          <label className="filter-label">
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={countryData.slice(0, 10)}>
                  ...
                  <Legend />
                  <Bar yAxisId="left" dataKey="value" name="Üretim" fill="#2ECC71" radius={[4, 4, 0, 0]} />
                  <Line yAxisId="right" type="monotone" dataKey="share" name="Pay %" stroke="#27AE60" strokeWidth={2} dot={{ fill: '#27AE60' }} />
                </ComposedChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Üretim (M ton)" dataKey="value" stroke="#2ECC71" fill="#2ECC71" fillOpacity={0.5} />
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ScatterChart>
                  ...
                  <Scatter name="Ürünler" data={scatterData} fill="#2ECC71">
