...
import type { useFertilizerPricing } from './useFertilizerPricing';

/**
 * Canlı USDTRY ile dünya gübre referanslarını TL/kg'a çeviren panel.
 *
 * Durum kancası (`useFertilizerPricing`) AYRI DOSYADA: bir dosya hem bileşen
 * hem kanca dışa aktarınca Vite'ın hızlı yenilemesi orada çalışmıyor.
 */
