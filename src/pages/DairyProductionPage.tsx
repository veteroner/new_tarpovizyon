...
interface DairyData {
  ...
  milkTypeDistribution: { name: string; value: number }[];
    ...
    <div>
      ...
      <div className="kpi-grid">
        ...
        <KPICard
          ...
          subtitle="Süt üreten ülke sayısı"
          icon={Globe}
          color="teal"
        />
        <KPICard
        ...
        <KPICard
          title="Süt Türü"
          value={data?.milkTypeDistribution.length.toString() || '0'}
          subtitle="Farklı süt kategorisi"
          icon={BarChart3}
          color="purple"
        />
      </div>
      ...
      <div className="chart-grid">
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <PieChart>
              <Pie
                data={data?.milkTypeDistribution}
                cx="50%"
                cy="50%"
                innerRadius={60}
                outerRadius={120}
              ...
              >
                {data?.milkTypeDistribution.map((_, index) => (
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={data?.yearlyTrend}>
            ...
            <Tooltip 
              ...
              contentStyle={{ background: '#1a1a24', border: '1px solid rgba(255,255,255,0.1)' }}
            />
            <Line type="monotone" dataKey="toplam" stroke="#3b82f6" strokeWidth={3} dot={{ fill: '#3b82f6' }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="data-table" style={{ marginTop: '1.5rem' }}>
        ...
        {data?.topCountries.map((country, index) => (
          <div key={index} className="table-row">
            <div className="table-rank" style={{ background: index < 3 ? '#3b82f6' : '#374151' }}>
              {index + 1}
            </div>
            ...
            <div className="table-value" style={{ color: '#3b82f6' }}>{formatTon(country.toplam)}</div>
          </div>
        ))}
      </div>
    </div>
