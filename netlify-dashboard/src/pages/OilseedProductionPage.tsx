...
const COLORS = ['#F4D03F', '#F5B041', '#EB984E', '#DC7633', '#D35400', '#CA6F1E', '#B9770E', '#A04000', '#873600', '#6E2C00'];

// FAO ürün kodları ile yağlı tohumlar
const OILSEED_PRODUCTS = [
  { id: '236', name: 'Soybeans', nameTR: 'Soya Fasulyesi' },
  { id: '242', name: 'Groundnuts', nameTR: 'Yer Fıstığı' },
  { id: '267', name: 'Sunflower seed', nameTR: 'Ayçiçeği' },
  { id: '270', name: 'Rapeseed', nameTR: 'Kanola' },
  { id: '289', name: 'Sesame seed', nameTR: 'Susam' },
  { id: '260', name: 'Olives', nameTR: 'Zeytin' },
  { id: '249', name: 'Coconuts', nameTR: 'Hindistan Cevizi' },
  { id: '254', name: 'Oil palm fruit', nameTR: 'Palmiye' },
];
...
export default function OilseedProductionPage() {
  const [selectedProducts, setSelectedProducts] = useState<string[]>(['236', '267', '270']);
    ...
    try {
      ...
      if (productRes.data) {
        const mapped = productRes.data.map((item, index: number) => {
          ...
          const product = OILSEED_PRODUCTS.find(p => p.id === urunKod);
          return {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p className="page-subtitle">Dünya yağlı tohum üretim miktarları - FAO {selectedYear} (Ton)</p>
      </div>
      ...
      <div className="date-filter">
        <div className="filter-group">
          ...
          <ProductSelector
            products={OILSEED_PRODUCTS}
            selectedProducts={selectedProducts}
            onSelectionChange={setSelectedProducts}
            placeholder="Yağlı tohum seçin..."
          />
        </div>
        <div className="filter-group">
          <label className="filter-label">
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={countryData.slice(0, 10)}>
                  ...
                  <Legend />
                  <Bar yAxisId="left" dataKey="value" name="Üretim" fill="#F4D03F" radius={[4, 4, 0, 0]} />
                  <Line yAxisId="right" type="monotone" dataKey="share" name="Pay %" stroke="#DC7633" strokeWidth={2} dot={{ fill: '#DC7633' }} />
                </ComposedChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Üretim (M ton)" dataKey="value" stroke="#F4D03F" fill="#F4D03F" fillOpacity={0.5} />
            ...
            <div className="chart-card">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <ScatterChart>
                  ...
                  <Scatter name="Ürünler" data={scatterData} fill="#F4D03F">
