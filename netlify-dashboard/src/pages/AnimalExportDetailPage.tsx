...
export function AnimalExportDetailPage() {
  ...
  const loadData = useCallback(async () => {
    setLoading(true);
    try {
      let detailQuery = queries.animalExportDetail;
  ...
  return (
    <div>
      ...
      <div className="page-header">
        <h1 className="page-title">🐄 Hayvansal Ürünler İhracat Detay Analizi</h1>
        <p className="page-subtitle">
          Hayvansal ürün bazlı detaylı ihracat verileri, ülkeler ve yıllık trendler
        </p>
      </div>
